...
public class PersonalLoginFragment extends Fragment implements LoginAsyncTaskInterface{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = LayoutInflater.from(getActivity()).inflate(R.layout.personal_login,
				null);
...
//					new LoginThread(app,u,pw).start();
	...
	private void changeTo(){
		...
		if(MainActivity.fm.findFragmentById(R.id.realtabcontent).getTag().equals("myfollow")){//如果是myfollow的tab下
			...
			from = PersonalTabFragment.childFm.findFragmentByTag("personalLoginFragment");
			if((to = PersonalTabFragment.childFm.findFragmentByTag("meFragment")) == null)
				to = new MeFragment();
			toTag = "meFragment";
			PersonalTabFragment.switchContent(from, to, toTag);
		}
	}
